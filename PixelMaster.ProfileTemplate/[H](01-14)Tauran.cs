...
public class Tauran01_14 : IPMProfile
{
    ...
    public IPMProfileContext Create()
    {
        ...
        IF(() => ME.Level < 3, "Grind Check");
            GrindMobsUntil(1, PlayerLevelReached: 3, "2955", "Grinding Until Level 3");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 3 - - - - - - - - - - - - - - - - - - -  
        ...
        GrindMobsUntil(1, PlayerLevelReached: 4, "2961", "Grinding Until Level 4");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 4 - - - - - - - - - - - - - - - - - - - 
        ...
        IF(() => ObjectManager.Instance.Player.Level < 5, "Grind Check");
        GrindMobsUntil(1, PlayerLevelReached: 5, "2966", "Grinding Until Level 5");
        EndIF();
        IF(() => ME.Class == UnitClass.Shaman);
        ...
        IF(() => ME.Level < 6, "Grind Check");
            GrindMobsUntil(1, PlayerLevelReached: 6, "2952,2953", "Grinding Until Level 6");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 6 - - - - - - - - - - - - - - - - - - - 
        ...
        //water 6747
        //repair 3080
        IF(() => ME.QuestLog.HasQuest(763));
            StartGroup(onChildFailure: TaskFailureBehavior.Continue);
            IF(() => ME.Class == UnitClass.Warrior);
                TrainSkill(1, 3063, "6673,100,772,6343,34428,3127");
            EndIF();
            IF(() => ME.Class == UnitClass.Shaman);
                TrainSkill(1, 3066, "8017,8042,2484,332");
            EndIF();
            IF(() => ME.Class == UnitClass.Hunter);
                TrainSkill(1, 3065, "1126,8921,774,467,5177");
            EndIF();
            IF(() => ME.Class == UnitClass.Druid);
                TrainSkill(1, 3064, "1126,8921,774,467,5177");
            EndIF();
        ...
        EndIF();
        IF(() => ME.QuestLog.IsCompleted(754) == false && ME.QuestLog.HasQuest(754) == false);
        ...
        IF(() => ME.Level < 8, "Grind Check");
            GrindMobsUntil(1, PlayerLevelReached: 8, "2958,2956,2969", "Grinding Until Level 8");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 8 - - - - - - - - - - - - - - - - - - - 
        ...
        IF(() => ME.QuestLog.HasQuest(761), onChildFailure: TaskFailureBehavior.Continue);
            IF(() => ME.Class == UnitClass.Warrior);
        ...
        IF(() => ME.Level < 9, "Grind Check");
            GrindMobsUntil(1, PlayerLevelReached: 9, "2962", "Grinding Until Level 9");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 9 - - - - - - - - - - - - - - - - - - - 
        ...
        GrindMobsUntil(1, PlayerLevelReached: 10, "2959,3035", "Grinding Until Level 10");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 10 - - - - - - - - - - - - - - - - - - - 
        IF(() => ME.QuestLog.IsCompleted(749) == false && ME.QuestLog.HasQuest(749) == false, onChildFailure: TaskFailureBehavior.Continue);
            IF(() => ME.Class == UnitClass.Warrior);
        ...
        //PickUp(1, 764, 2948, "The Venture Co.", Hotspots: "(-2445.01, -1118.822, -9.424)(-2290.005, -581.245, -9.276)");die alot
        //PickUp(1, 765, 2948, "Supervisor Fizsprocket", Hotspots: "(-2445.01, -1118.822, -9.424)(-2290.005, -581.245, -9.276)");die alot
        KillMobs(1, 759, "2960", "Wildmane Totem", LootMobs: true, PullRange: 50);
        IF(() => ME.Level < 11, "Grind Check");
            GrindMobsUntil(1, PlayerLevelReached: 11, "2960", "Grinding Until Level 11");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 11 - - - - - - - - - - - - - - - - - - - 
        ...
        GrindMobsUntil(1, PlayerLevelReached: 12, "2960", "Grinding Until Level 12");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 12 - - - - - - - - - - - - - - - - - - - 
        IF(() => ME.QuestLog.HasQuest(773), onChildFailure: TaskFailureBehavior.Continue);
            SellBuyStuff2(6747, 6747, 3080, 0, 3076);
            IF(() => ME.Class == UnitClass.Warrior);
        ...
        //TurnIn(1, 764, 2948, "The Venture Co.", Hotspots: "(-2445.01, -1118.822, -9.424)(-2290.005, -581.245, -9.276)");
        //TurnIn(1, 765, 3051, "Supervisor Fizsprocket", Hotspots: "(-2445.01, -1118.822, -9.424)(-2290.005, -581.245, -9.276)");
        ...
        GrindMobsUntil(1, PlayerLevelReached: 13, "2964,2965", "Grinding Until Level 13");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 13 - - - - - - - - - - - - - - - - - - - 
        IF(() => ME.QuestLog.HasQuest(773), onChildFailure: TaskFailureBehavior.Continue);
            SellBuyStuff2(6747, 6747, 3080, 0, 3076);
            IF(() => (ME.Class == UnitClass.Hunter));
                BuyItems(1, 3025, "2287", 40, "Buy Food");
            EndIF();
            IF(() => ME.Class == UnitClass.Warrior);
                TrainSkill(1, 3063, "6673,100,772,6343,34428,3127,1715,284,2687,6546,5242,7384");
            EndIF();
        ...
        GrindMobsUntil(1, PlayerLevelReached: 14, "2964,2965", "Grinding Until Level 14");
        EndIF();
        //- - - - - - - - - - - - - - - - LEVEL 14 - - - - - - - - - - - - - - - - - - - 
        ...
        EndGroup();
        //-------------------------------END PROFILE-------------------------------
        //LoadProfileFromFile("[H-Quest](14-17)Barrens[Cava].cs");
        return EndProfile();
    }
